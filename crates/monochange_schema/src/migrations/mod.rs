...
const RELEASE_RECORD_EDGES: &[MigrationEdge] = &[
	...
	MigrationEdge {
		from: SchemaVersion::new(0, 3),
		to: SchemaVersion::new(0, 4),
		apply: release_record_0_3_to_0_4::apply,
	},
	MigrationEdge {
		from: SchemaVersion::new(0, 4),
	...
	MigrationEdge {
		from: SchemaVersion::new(0, 6),
		to: SchemaVersion::new(0, 7),
		apply: release_record_0_6_to_0_7::apply,
	},
	MigrationEdge {
		from: SchemaVersion::new(0, 7),
		to: SchemaVersion::new(0, 8),
		apply: release_record_0_7_to_0_8::apply,
	},
];
