...
- No package-specific changes were recorded; `monochange_config` was updated to 0.9.1 as part of group `main`.
...
- No package-specific changes were recorded; `monochange_config` was updated to 0.8.2 as part of group `main`.
...
- No package-specific changes were recorded; `monochange_config` was updated to 0.6.6 as part of group `main`.
...
- No package-specific changes were recorded; `monochange_config` was updated to 0.6.4 as part of group `main`.

## [0.6.3](https://github.com/monochange/monochange/releases/tag/v0.6.3) (2026-05-28)

### Changed

- No package-specific changes were recorded; `monochange_config` was updated to 0.6.3 as part of group `main`.
...
- No package-specific changes were recorded; `monochange_config` was updated to 0.3.2 as part of group `main`.
