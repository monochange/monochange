...
- Include exact validation commands and relevant output. Prefer repository scripts such as `monochange step validate`, `lint:all`, `build:all`, `docs:update`, and `docs:check` where they apply.
