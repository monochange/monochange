...
- `./validate-examples.sh` runs `monochange step validate`, `monochange check`, and `monochange run release --dry-run --diff` against every repo-shaped example in this folder
