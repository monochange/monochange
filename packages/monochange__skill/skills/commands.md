...
1. **Binary commands** are wired directly in `crates/monochange_cli/src/cli.rs`.
...
- `crates/monochange_cli/src/cli.rs` for Clap command literals such as `init`, `migrate`, `lint`, and `help`.
