...
assertContains(".templates/guides.t.md", "monochange step diagnose-changesets --format json");
assertContains(".templates/guides.t.md", "monochange step prepare-release --dry-run --format json");
